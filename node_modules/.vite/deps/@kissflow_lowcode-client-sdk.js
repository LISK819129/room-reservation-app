...
// node_modules/@kissflow/lowcode-client-sdk/dist/kfsdk.es.js
...
var _textEncoder;
var _textDecoder;
var _registerComponentAPIs;
var registerComponentAPIs_fn;
...
var BaseSDK = class extends EventBase {
...
var sharedArrayBufferInstance;
var AtomicsHandler = class {
  constructor() {
...
_textEncoder = /* @__PURE__ */ new WeakMap();
_textDecoder = /* @__PURE__ */ new WeakMap();
var Client = class extends BaseSDK {
  showInfo(message) {
...
var Formatter = class extends BaseSDK {
  toDate(date) {
...
var Component = class extends BaseSDK {
  constructor(props) {
    super();
...
_registerComponentAPIs = /* @__PURE__ */ new WeakSet();
...
var CustomComponent = class extends BaseSDK {
  constructor(id) {
    super();
    this._id = id;
...
var Popup = class extends BaseSDK {
  constructor(props) {
    super();
    this.type = "Popup";
...
var Page = class extends BaseSDK {
...
var DecisionTable = class extends BaseSDK {
  constructor(flowId) {
    super();
    this.flowId = flowId;
  }
...
var Dataform = class extends BaseSDK {
  constructor(flowId) {
    super();
    this._id = flowId;
  }
...
var Board = class extends BaseSDK {
  constructor(flowId) {
    super();
    this._id = flowId;
  }
...
var Process = class extends BaseSDK {
  constructor(flowId) {
    super();
    this._id = flowId;
  }
...
var Application = class extends BaseSDK {
  constructor(props, isCustomComponent = false) {
    super();
...
var CustomComponentSDK = class extends BaseSDK {
  constructor() {
    super();
  }
  api(url, args) {
...
//# sourceMappingURL=@kissflow_lowcode-client-sdk.js.map
